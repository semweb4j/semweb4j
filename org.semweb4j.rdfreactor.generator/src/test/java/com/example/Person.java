...
public class Person extends Thing {
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@4957c7 has at least one value set 
     * @param model an RDF2Go model
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@4957c7 has the given value (maybe among other values).  
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
