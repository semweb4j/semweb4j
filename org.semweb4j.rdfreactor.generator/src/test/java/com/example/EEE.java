...
public class EEE extends Thing {
	 ...
	 */
	public static ReactorResult<? extends EEE> getAllInstance_as(Model model) {
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@15b5c1f has at least one value set 
     * @param model an RDF2Go model
