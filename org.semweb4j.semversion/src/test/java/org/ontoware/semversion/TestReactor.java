...
public class TestReactor {
	...
	public void testReactorParts() throws Exception {
		...
		VersionedModel vm1 = new VersionedModel(mainModel, session,new URIImpl("data://vm1"),true);
		vm1.setLabel("Gene Ontology");

		Version version1 = new Version(mainModel, session,new URIImpl("data://version1"), true);
		...
		Version version1_1 = new Version(mainModel, session,new URIImpl("data://version1-1"), true);
