...
public class DataTypeTesting {
	...
	public void testOldDataTypesUsedAsIntended() throws Exception {
		...
		com.hp.hpl.jena.rdf.model.Model model = ModelFactory
				.createDefaultModel();
	...
	public void testNewToJenaNode() throws ModelRuntimeException {
		...
		DatatypeLiteralImpl l1 = new DatatypeLiteralImpl("test", new URIImpl(
				"test:funky", false));
		DatatypeLiteralImpl l2 = new DatatypeLiteralImpl("test", new URIImpl(
				"test:funky", false));
