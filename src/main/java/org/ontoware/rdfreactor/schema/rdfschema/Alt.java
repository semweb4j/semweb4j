...
public class Alt extends Container {
	 ...
	 */
	protected Alt ( Model model, URI classURI, org.ontoware.rdf2go.model.node.Resource instanceIdentifier, boolean write ) {
	 ...
	 * @param write if true, the statement (this, rdf:type, TYPE) is written to the model
	 */
	public Alt ( Model model, org.ontoware.rdf2go.model.node.Resource instanceIdentifier, boolean write ) {
	 ...
	 * @param write if true, the statement (this, rdf:type, TYPE) is written to the model
	 */
	public Alt ( Model model, String uriString, boolean write) {
	 ...
	 * @return an instance of Alt or null if none existst
	 * @throws Exception if Model causes problems
	 */
	public static Alt getInstance(Model model, URI uri) throws Exception {
		return (Alt) getInstance(model, uri, Alt.class);
	}
	 ...
	 */
	public static Alt[] getAllInstances(Model model) {
