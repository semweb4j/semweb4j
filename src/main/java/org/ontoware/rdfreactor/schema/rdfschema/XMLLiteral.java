...
public class XMLLiteral extends Resource {
	 ...
	 */
	protected XMLLiteral ( Model model, URI classURI, org.ontoware.rdf2go.model.node.Resource instanceIdentifier, boolean write ) {
	 ...
	 * @param write if true, the statement (this, rdf:type, TYPE) is written to the model
	 */
	public XMLLiteral ( Model model, org.ontoware.rdf2go.model.node.Resource instanceIdentifier, boolean write ) {
	 ...
	 * @param write if true, the statement (this, rdf:type, TYPE) is written to the model
	 */
	public XMLLiteral ( Model model, String uriString, boolean write) {
	 ...
	 * @param write if true, the statement (this, rdf:type, TYPE) is written to the model
	 */
	public XMLLiteral ( Model model, BlankNode bnode, boolean write ) {
	 ...
	 * @param write if true, the statement (this, rdf:type, TYPE) is written to the model
	 */
	public XMLLiteral ( Model model, boolean write ) {
	 ...
	 * @return an instance of XMLLiteral or null if none existst
	 * @throws Exception if Model causes problems
	 */
	public static XMLLiteral getInstance(Model model, URI uri) throws Exception {
		return (XMLLiteral) getInstance(model, uri, XMLLiteral.class);
	}
	 ...
	 */
	public static XMLLiteral[] getAllInstances(Model model) {
		return (XMLLiteral[]) getAllInstances(model, XMLLiteral.class);
	}
