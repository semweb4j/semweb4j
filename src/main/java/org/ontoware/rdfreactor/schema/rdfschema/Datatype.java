...
public class Datatype extends Resource {
	 ...
	 * @param write if true, the statement (this, rdf:type, TYPE) is written to the model
	 */
	public Datatype ( Model model, String uriString, boolean write) {
	 ...
	 * @return an instance of Datatype or null if none existst
	 * @throws Exception if Model causes problems
	 */
	public static Datatype getInstance(Model model, URI uri) throws Exception {
		return (Datatype) getInstance(model, uri, Datatype.class);
	}
	 ...
	 */
	public Datatype[] getAllInstances() {
		return (Datatype[]) getAllInstances(super.model, Datatype.class);
	}
	 ...
	 */
	public static Datatype[] getAllInstances(Model model) {
		return (Datatype[]) getAllInstances(model, Datatype.class);
	}
