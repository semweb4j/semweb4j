...
public class DumpUtils {
	...
	public static String toN3(Model m) {
		try {
			ModelImplJena24 jModel = new ModelImplJena24(Reasoning.none);
	 ...
	 * 
	 * @param options
	 *            null for default. format: "n3"|"rdfxml"|"ntriple", output:
	 *            "sysout"|"log"
	 * @throws Exception
	 *             Jena knows: "RDF/XML","RDF/XML-ABBREV", "N-TRIPLE" and "N3".
	 */
