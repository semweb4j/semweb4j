...
public class DataTypeTesting extends TestCase {
	...
	public void testDataTypeEqualness() throws Exception {
		...
		LiteralLabel litA11 = new LiteralLabel("teststring", "", BDtestA1);
		...
		LiteralLabel litA12 = new LiteralLabel("teststring", "", BDtestA1);
		...
		LiteralLabel litA2 = new LiteralLabel("teststring", "", BDtestA2);
		...
		LiteralLabel litB = new LiteralLabel("teststring", "", BDtestB);
	...
	public void testGeneralDataTypeEqualness() throws Exception {
		...
		// Es kann passieren das mit addStatement(object, object, object, object)
		...
		// gleichen Literal verglichen, aber die zweite Instanz hat einen BaseDatatype
		// weil sie automatisch in Search-Triple oder irgend sowas eingef�gt wurde. 
		// Da GeneralDataType auf BaseDatatype down-gecastet werden kann, werden sie
		// dann mit dem BaseDatatype.equals() verglichen und dann passt es wieder nicht.
		...
		// gleicher Inhalt, in zwei versch. Objekten, passt auch
		assertTrue(litA11.sameValueAs(litA12));
		// zwei Objekte, mit untersch. BaseDatatypes, von der gleichen Datatype URI:
	
		// ACHTUNG: mit GeneralDataType passt das jetzt weil f�r die Gleichheit der Datentypen 
		...
		// so implementiert, das die URIs der Datentypen verglichen werden und die Werte der Strings
...
//		Literal tmpLit = tmpModel.createTypedLiteral("123", dt );
	...
	public void testDataTypesWithUnknownType() throws Exception {
		...
		// siehe dazu com.hp.hpl.jena.graph.test.TestTypedLiterals.java, Funktion testUnknown()
		// das ganze funktioniert sowohl mit Jena2.2 als auch mit dem jena aus dem cvs
		
		// das ganze Problem scheint wohl zu sein das Jena ziemlich abgefahrene Sachen machen kann
		...
		// Dieser gesamte Test testet direkt die Funktion von Jena, nicht von rdf2go. (SG)
		...
		// das hier scheint alles zu sein was notwendig ist damit Jena die data typed literals
        ...
        // im jena cvs geht auch folgendes, damit kann man das Object des Daten Typs besser manipulieren
