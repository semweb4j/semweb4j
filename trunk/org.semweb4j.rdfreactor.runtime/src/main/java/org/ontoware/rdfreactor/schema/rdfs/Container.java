...
public class Container extends Resource {
	 ...
	 * That is, create the statement (instanceResource, RDF.type, http://www.w3.org/2000/01/rdf-schema#Container).
	 ...
	 */
	public static ReactorResult<? extends Container> getAllInstance_as(Model model) {
