...
public class EEE extends Thing1 {
    ...
    private static final long serialVersionUID = -3857566215881259909L;
	 ...
	 */
	protected EEE (Model model, URI classURI, org.ontoware.rdf2go.model.node.Resource instanceIdentifier, boolean write) {
	 ...
	 */
	public EEE (Model model, org.ontoware.rdf2go.model.node.Resource instanceIdentifier, boolean write) {
	 ...
	 */
	public static EEE getInstance(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource) {
    ...
    /**
	 * Remove rdf:type EEE from this instance. Other triples are not affected.
