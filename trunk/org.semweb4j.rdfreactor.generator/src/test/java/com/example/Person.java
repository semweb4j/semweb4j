...
public class Person extends Thing1 {
    ...
    private static final long serialVersionUID = 9092868232436957940L;
    ...
    /**
     * Check if Pet has at least one value set.
     * @param model an RDF2Go model
    ...
    /**
     * Check if Pet has the given value (maybe among other values).
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
    ...
    /**
     * Get all values of property Pet.
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
