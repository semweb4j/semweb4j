...
/**
 * A <b>JProperty</b> represents a property of a JClass in the JModel. (A
 * JProperty can be thought of as a property in the Java Bean sense.)
 * 
 * Every JProperty has a name, a comment, a URI to which it is Mapped in the
 * JModel, a List of JClasses from which it is a property, an inverse property,
 * as well as a minimum and maximum cardinality.
 * 
 * @author $Author: xamde $
...
public class JProperty extends JMapped {
    ...
    /**
     * @param type is added to the list of JClasses having this JProperty as a
     *            range
     */
     ...
     * date
     * 
     * @param jm is the JModel in which JClasses using this JProperty are
     *            searched for
     */
    ...
    /** @return a verbose report of this JProperty */
