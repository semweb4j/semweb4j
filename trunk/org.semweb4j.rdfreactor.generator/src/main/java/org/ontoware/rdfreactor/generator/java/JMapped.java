...
/**
 * <b>JMapped</b> is used as the superclass of Objects in a JModel which can be
 * mapped to an URI.
 * 
 * Every JMapped instance has a name, a comment and an URI to which it can be
 * mapped in the representation of the JModel.
 * 
 * @author $Author: xamde $
...
public class JMapped {
    ...
    /**
     * @return the last part of the name (starting after the last dot in the
     *         name)
     */
     ...
     * for velocity
     * 
     * @return a dot-free version of the name
     */
