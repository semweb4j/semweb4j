...
public class RDFModel extends Thing {
	 ...
	 */
	public RDFModel ( Model model, String uriString, boolean write) throws ModelRuntimeException {
	 ...
	 */
	public RDFModel ( Model model, BlankNode bnode, boolean write ) {
	 ...
	 */
	public RDFModel ( Model model, boolean write ) {
	 ...
	 * That is, create the statement (instanceResource, RDF.type, http://purl.org/net/semversion#RDFModel).
	 ...
	 */
	public static ReactorResult<? extends RDFModel> getAllInstance_as(Model model) {
		return Base.getAllInstances_as(model, RDFS_CLASS, RDFModel.class );
	}
	 ...
	 * @param model an RDF2Go model
	 * @param objectValue
	 * @return all A's as RDF resources, that have a relation 'Content' to this RDFModel instance
	 *
	 * [Generated from RDFReactor template rule #getallinverse1static] 
	 */
	public static ClosableIterator<org.ontoware.rdf2go.model.node.Resource> getAllContent_Inverse( Model model, Object objectValue) {
		return Base.getAll_Inverse(model, Version.CONTENT, objectValue);
	}
