...
public class TestData {
	 ...
	 * 
	 * @param factory
	 *            the factory to use to create the model
	 * @return the loaded model
	 */
	public static Model loadFoafBuffered(ModelFactory factory)
	...
	public static InputStream getFoafAsStream() {
		...
		return classloader.getResourceAsStream("foaf.xml");
		// old impl:  return TestData.class.getResourceAsStream("foaf.xml");
	}
	 ...
	 * @return the loaded model
	 */
	public static Model loadICALBuffered(ModelFactory factory)
			throws IOException, ModelRuntimeException {
	...
	public static InputStream getICALAsStream() {
		ClassLoader classloader = Thread.currentThread().getContextClassLoader();
		return classloader.getResourceAsStream("icaltzd.rdfs");
		// old impl: return TestData.class.getResourceAsStream("icaltzd.rdfs");
	}
