...
import org.ontoware.aifbcommons.collection.impl.PseudoClosableIterator;
...
public class ModelAddRemoveMemoryImpl extends AbstractModelAddRemove implements ModelAddRemove {
	...
	public ClosableIterator<Statement> iterator() {
		return new PseudoClosableIterator<Statement>( set.iterator() );
	}
