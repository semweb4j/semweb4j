...
public abstract class AbstractModel extends AbstractModelRemovePatterns
	...
	private static Log log = LogFactory.getLog(AbstractModel.class);
	...
	public Diff getDiff(Iterator<? extends Statement> other)
		...
		// TODO: this does not look very save regarding ClosableIterators
	...
	public void close() {
		if (!isOpen()) {
			// log.warn("Model was closed already, ignored.");
		} else {
			this.open = false;
		}
	}
