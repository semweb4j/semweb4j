 ...
 * </p>
 * <code>
 * // register adapter of implementation XXX, could be Jena or Sesame or anything.
 * RDF2Go.register( new org.ontoware.rdf2go.impl.XXX.ModelFactoryImpl() );
 * 
 * // start using RDF2Go
...
public class RDF2Go {
	...
	private static final Log log = LogFactory.getLog( RDF2Go.class );
