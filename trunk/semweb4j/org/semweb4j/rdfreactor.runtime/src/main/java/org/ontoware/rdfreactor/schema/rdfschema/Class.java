...
public class Class extends org.ontoware.rdfreactor.schema.rdfschema.Resource {
	...
	public Resource[] getAllType_Inverse() {
		return (Resource[]) getAll_Inverse(org.ontoware.rdfreactor.schema.rdfschema.Resource.TYPE, this.getResource(), Resource.class);
	}

	/**
	 * add 'Type'-Inverse
	 */
	public void addType_Inverse(org.ontoware.rdfreactor.schema.rdfschema.Resource value) {
		value.add( org.ontoware.rdfreactor.schema.rdfschema.Resource.TYPE ,this);
	}
