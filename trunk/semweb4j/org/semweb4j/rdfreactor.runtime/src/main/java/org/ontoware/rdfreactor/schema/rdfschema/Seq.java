...
public class Seq extends Container {
	 ...
	 */
	protected Seq ( Model model, URI classURI, Resource instanceIdentifier, boolean write ) {
	 ...
	 * @param write if true, the statement (this, rdf:type, TYPE) is written to the model
	 */
	public Seq ( Model model, Resource instanceIdentifier, boolean write ) {
	 ...
	 * @param uri URI of this instance
	 */
	public Seq ( Model model, URI uri ) {
		this(model, uri, true);
	}
	 ...
	 */
	public Seq ( Model model, BlankNode bnode ) {
