...
public class Datatype extends Class {
	 ...
	 */
	protected Datatype ( Model model, URI classURI, Resource instanceIdentifier, boolean write ) {
	 ...
	 * @param write if true, the statement (this, rdf:type, TYPE) is written to the model
	 */
	public Datatype ( Model model, Resource instanceIdentifier, boolean write ) {
	 ...
	 * @param uri URI of this instance
	 */
	public Datatype ( Model model, URI uri ) {
		this(model, uri, true);
	}
	 ...
	 */
	public Datatype ( Model model, BlankNode bnode ) {
