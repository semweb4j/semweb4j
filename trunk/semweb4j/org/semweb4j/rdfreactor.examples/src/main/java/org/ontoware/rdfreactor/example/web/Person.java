 ...
 */
package org.ontoware.rdfreactor.example.web;
...
public class Person extends Class {
    ...
    /** http://purl.org/net/xamde/ns/test#Name */
	public static final URI NAME = URIImpl.createURIWithoutChecking("http://purl.org/net/xamde/ns/test#Name");
	...
	public Person ( Model model, String uriString ) throws ModelRuntimeException {
		super(model, model.createURI(uriString));
	}
