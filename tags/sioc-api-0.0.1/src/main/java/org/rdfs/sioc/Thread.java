...
public class Thread extends Container {
	 ...
	 */
	public Thread ( Model model, URI uri ) {
		this(model, uri, true);
	}
	 ...
	 */
	public Thread ( Model model, String uriString ) throws ModelRuntimeException {
	 ...
	 */
	public Thread ( Model model, BlankNode bnode ) {
	 ...
	 */
	public static Thread getInstance(Model model, URI uri) throws Exception {
		return (Thread) getInstance(model, uri, Thread.class);
	}
	 ...
	 */
	public Thread[] getAllInstances() {
		return (Thread[]) getAllInstances(super.model, Thread.class);
	}
	 ...
	 */
	public static Thread[] getAllInstances(Model model) {
		return (Thread[]) getAllInstances(model, Thread.class);
	}
