...
public class FunctionalProperty extends OwlProperty {
	 ...
	 * That is, create the statement (instanceResource, RDF.type, http://www.w3.org/2002/07/owl#FunctionalProperty).
	 ...
	 */
	public static ReactorResult<? extends FunctionalProperty> getAllInstance_as(Model model) {
		return Base.getAllInstances_as(model, RDFS_CLASS, FunctionalProperty.class );
	}
