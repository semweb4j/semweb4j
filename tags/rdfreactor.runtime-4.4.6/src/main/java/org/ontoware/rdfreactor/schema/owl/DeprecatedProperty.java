...
public class DeprecatedProperty extends Property {
	...
	public static DeprecatedProperty getInstance(Model model, URI uri) throws Exception {
		return (DeprecatedProperty) getInstance(model, uri, DeprecatedProperty.class);
	}
	 ...
	 */
	public DeprecatedProperty[] getAllInstances() {
		return (DeprecatedProperty[]) getAllInstances(super.model, DeprecatedProperty.class);
	}
	 ...
	 */
	public static DeprecatedProperty[] getAllInstances(Model model) {
		return (DeprecatedProperty[]) getAllInstances(model, DeprecatedProperty.class);
	}
