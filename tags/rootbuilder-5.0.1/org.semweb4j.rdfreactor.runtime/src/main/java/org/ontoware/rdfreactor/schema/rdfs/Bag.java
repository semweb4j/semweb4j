...
public class Bag extends Container {
	 ...
	 * That is, create the statement (instanceResource, RDF.type, http://www.w3.org/1999/02/22-rdf-syntax-ns#Bag).
	 ...
	 */
	public static ReactorResult<? extends Bag> getAllInstance_as(Model model) {
		return Base.getAllInstances_as(model, RDFS_CLASS, Bag.class );
	}
