...
public class JavaNamingUtils {
    ...
    public static String toLegalJavaIdentifier(String illegal) {
        ...
        if(!"abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ".contains(beanname
                .substring(0, 1)))
    ...
    public static String guessNSPrefix(String uriString) {
        ...
        namespace2prefix.put("http://www.w3.org/1999/02/22-rdf-syntax-ns#", "rdf");
        ...
        namespace2prefix.put("http://musicbrainz.org/mm/mm-2.1#", "musicbrainz21");
