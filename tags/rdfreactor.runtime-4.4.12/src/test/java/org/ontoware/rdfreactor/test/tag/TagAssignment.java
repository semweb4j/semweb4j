...
public class TagAssignment extends Thing {
	...
	public static final URI RDFS_CLASS = new URIImpl("urn:tag#TagAssignment");

    /** urn:tag#hasFile */
	public static final URI FILE = new URIImpl("urn:tag#hasFile");

    /** urn:tag#hasTag */
	public static final URI TAG = new URIImpl("urn:tag#hasTag");

    /** all property-URIs with this class as domain */
    public static final URI[] MANAGED_URIS = {
      new URIImpl("urn:tag#hasFile"),
      new URIImpl("urn:tag#hasTag") 
    };
