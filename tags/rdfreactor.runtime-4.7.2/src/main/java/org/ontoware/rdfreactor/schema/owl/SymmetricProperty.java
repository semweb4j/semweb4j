...
public class SymmetricProperty extends ObjectProperty {
	 ...
	 */
	public SymmetricProperty ( Model model, String uriString, boolean write) throws ModelRuntimeException {
	 ...
	 * That is, create the statement (instanceResource, RDF.type, http://www.w3.org/2002/07/owl#SymmetricProperty).
	 ...
	 */
	public static ReactorResult<? extends SymmetricProperty> getAllInstance_as(Model model) {
		return Base.getAllInstances_as(model, RDFS_CLASS, SymmetricProperty.class );
	}
