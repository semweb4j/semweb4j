...
public class Seq extends Container {
	 ...
	 * That is, create the statement (instanceResource, RDF.type, http://www.w3.org/1999/02/22-rdf-syntax-ns#Seq).
	 ...
	 */
	public static ReactorResult<? extends Seq> getAllInstance_as(Model model) {
		return Base.getAllInstances_as(model, RDFS_CLASS, Seq.class );
	}
