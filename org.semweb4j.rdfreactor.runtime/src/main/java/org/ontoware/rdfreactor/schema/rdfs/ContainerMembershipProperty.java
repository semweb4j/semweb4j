...
public class ContainerMembershipProperty extends Property {
	 ...
	 * That is, create the statement (instanceResource, RDF.type, http://www.w3.org/2000/01/rdf-schema#ContainerMembershipProperty).
	 ...
	 */
	public static ReactorResult<? extends ContainerMembershipProperty> getAllInstance_as(Model model) {
		return Base.getAllInstances_as(model, RDFS_CLASS, ContainerMembershipProperty.class );
	}
