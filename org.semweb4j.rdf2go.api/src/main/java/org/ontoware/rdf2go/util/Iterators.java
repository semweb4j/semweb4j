 ...
 * 
 * copied into RDF2Go by Leo Sauemann on 11.1.2007, it helps to get working
 * quicker.
 */
public class Iterators {
	 ...
	 * 
	 * @param iter An iterator over arbitrary objects that are expected to
	...
	/**
	 * Runs through the iterator and returns number of items. It doesn't close
	 * it.
	 * 
	 * @author clemente
	 * 
